package tech.jotave.demoparkapi.jwt;
...
public class JwtUtils {
    ...
    public static final String SECRET_KEY = "minhachavesecreta123456789101112131415";
    ...
    private static Date toExpire(Date start) {
